...
public:
	Stack();
	virtual void push(string w);
	virtual string pop();
	virtual string top();
	virtual bool isEmpty();
	virtual bool isFull();
	virtual void print();
	virtual ~Stack(){cout << "base class destructor called";}
};
*/
...
void test_Stack(string file_name, StackArray& L, string output_file)
{
...
int main(int argc, char* argv[])
{
	...
	StackArray a(2000);
	test_Stack(input_file, a, output_file);
